...
// Sửa dòng import này: dùng getFirestore chuẩn
...
// --- ĐÃ SỬA: Dùng getFirestore mặc định ---
// Việc này giúp kết nối WebSockets ổn định, đồng bộ đúng trạng thái đăng nhập
